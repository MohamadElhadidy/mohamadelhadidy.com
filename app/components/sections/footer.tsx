...
export default function Footer() {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("contact@mohamadelhadidy.com");
        setCopied(true);
        ...
        <footer id="footer" >
            ...
            <div className={styles.footer__content}>
                ...
                <p
                    ...
                    title="Click to copy"
                >
                    {copied ? 'Copied!' : 'contact@mohamadelhadidy.com'}
                </p>                <div className={styles.footer__socials}>
