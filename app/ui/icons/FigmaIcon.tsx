        ...
        >
            {isHovered ?
                ...
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="default_icon icon">
                    <path d="M23.5 37.3333C23.5 40.7372 20.7372 43.5 17.3333 43.5C13.9295 43.5 11.1667 40.7372 11.1667 37.3333C11.1667 33.9295 13.9295 31.1667 17.3333 31.1667H23.5V37.3333Z" stroke="currentColor" strokeOpacity="0.95" />
                    <path d="M11.1667 24C11.1667 20.5962 13.9295 17.8333 17.3333 17.8333H23.5V30.1667H17.3333C13.9295 30.1667 11.1667 27.4039 11.1667 24Z" stroke="currentColor" strokeOpacity="0.95" />
                    <path d="M11.1667 10.6667C11.1667 7.26281 13.9295 4.5 17.3333 4.5H23.5V16.8333H17.3333C13.9295 16.8333 11.1667 14.0705 11.1667 10.6667Z" stroke="currentColor" strokeOpacity="0.95" />
                    <path d="M24.5 4.5H30.6667C34.0705 4.5 36.8333 7.26281 36.8333 10.6667C36.8333 14.0705 34.0705 16.8333 30.6667 16.8333H24.5V4.5Z" stroke="currentColor" strokeOpacity="0.95" />
                    <path d="M36.8333 24C36.8333 27.4039 34.0705 30.1667 30.6667 30.1667C27.2628 30.1667 24.5 27.4039 24.5 24C24.5 20.5962 27.2628 17.8333 30.6667 17.8333C34.0705 17.8333 36.8333 20.5962 36.8333 24Z" stroke="currentColor" strokeOpacity="0.95" />
                </svg>
